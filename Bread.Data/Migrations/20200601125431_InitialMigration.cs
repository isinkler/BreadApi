    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantKitchenTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantKitchenTypes_KitchenTypes_KitchenTypeId",
                        column: x => x.KitchenTypeId,
                        principalTable: "KitchenTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantKitchenTypes_Restaurants_RestaurantId",
                        column: x => x.RestaurantId,
                        principalTable: "Restaurants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RedeemedVouchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RedeemedVouchers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RedeemedVouchers_Vouchers_VoucherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(nullable: false),
                    UserId = table.Column<int>(nullable: false),
                    OrderReviewId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RedeemedVouchers_UserId",
                table: "RedeemedVouchers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RedeemedVouchers_VoucherId",
                table: "RedeemedVouchers",
                column: "VoucherId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantKitchenTypes_KitchenTypeId",
                table: "RestaurantKitchenTypes",
                column: "KitchenTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantKitchenTypes_RestaurantId",
                table: "RestaurantKitchenTypes",
                column: "RestaurantId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Orders_OrderReviews_OrderReviewId",
                table: "Orders",
                column: "OrderReviewId",
